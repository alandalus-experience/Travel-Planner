		...
		<div className={styles['recover-password']}>
			...
			<div className={styles['recover-card']}>
				<div className={styles['recover-block']}>
					<h2 className={styles['recover-title']}>Recover Password</h2>
				</div>
				<div className={styles['recover-block']}>
					<span className={styles['recover-message']}>Don`t worry, happens to the best of us</span>
				</div>
				<div className={styles['recover-block']}>
					<span className={styles['recover-text']}>Your email</span>
				</div>
				<div className={styles['recover-block']}>
					<input
						type="text"
